...
void processclient(int sockfd) {
    ...
    while (1) {
        ...
        } else if (strcmp(token, "findfile") == 0) {  //execution of findfile command
        ...
        } else if (strcmp(token, "sgetfiles") == 0) {  //execution of sgetfiles command
    ...
    }else if (strcmp(token, "quit") == 0) { //quit command execution
